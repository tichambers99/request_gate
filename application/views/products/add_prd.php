                ...
                <div class="col-md-4 col-md-offset-2">
                    <div class="left-action text-left clearfix">
                        <h2><i class="fa fa-refresh" style="font-size: 14px; cursor: pointer;"
                               onclick="cms_vcrproduct('1')"></i>Tạo báo cáo </h2>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-4 padd-0">
                        ...
                        <small>Nhập tên và các thông tin cơ bản của báo cáo </small>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    <label>Mã việc được giao </label>
                                    ...
                                    <div class="col-md-11 padd-0">
                                        <select class="form-control" id="prd_group_id">
                                            <optgroup label="chọn tình trạng công việc  ">
                                             
                                                   
                                            </optgroup>
                                            <optgroup label="------------------------">
                                                <option value="product_group" data-toggle="modal"
                                                        data-target="#list-prd-group">Lựa chọn vệc  
                                                </option>
                                            </optgroup>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 padd-right-0">
                                    <label>Tên việc được giao</label>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-md-14 padd-left-0">
                                    <label>Tình trạng </label>
                                    ...
                                    <div class="col-md-11 padd-0">
                                        <select class="form-control" id="prd_group_id">
                                            ...
                                            <optgroup label="------------------------">
                                                <option value="product_group" data-toggle="modal"
                                                        data-target="#list-prd-group">Lựa chọn tình trạng 
                                                </option>
                                            </optgroup>
                                        </select>
                                    </div>
                                ...
                                <!-- <div class="col-md-6 padd-right-0">
                                    <label>Lỗi phát sinh </label>
                                    <div class="col-md-11 padd-0">
                                        <select class="form-control" id="prd_manufacture_id">
                                            <optgroup label="có lỗi xuất hiện hay không ? ">
                                            ...
                                            <optgroup label="------------------------">
                                                <option value="product_manufacture" data-toggle="modal"
                                                        data-target="#list-prd-manufacture">có phát sinh lỗi hay không 
                                                </option>
                                            </optgroup>
                                        </select>
                                    </div>
                ...
                <div class="col-md-12">
                    <h4 style="border-bottom: 1px solid #0B87C9; padding-bottom: 10px;"><i
                            class="fa fa-th-large blue"></i> <a style="color: #0B87C9; text-decoration: none;"
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseExample">Thông tin mô tả cụ thể(
                            <small> Nhấn để thêm các thông tin chi tiết </small>
                            )</a></h4>
                </div>
                <div class="col-md-12">
                    ...
                    <div class="collapse" id="collapseproductinfo">
                            ...
                            <div class="row">
                                <div class="col-md-12 padd-20">
                                    <div class="jumbotron text-center" id="img_upload"
                                        ...
                                        <h3>Upload hình ảnh kết quả công việc </h3>
                        ...
                        <div class="col-md-12 padd-20">
                            <h4 style="margin-top: 0;">Mô tả
                                <small style="font-style: italic;">(Nhập thông tin mô tả chi tiết hơn về công việc được giao )
                                </small>
                            </h4>
